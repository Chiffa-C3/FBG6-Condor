...
Провода, которые будут использоваться для подключения датчика Klicky, зачищаем на свободных концах, продеваем в предусмотренные отверстия, загибаем в пазы, а затем в отверстие запресовываются магниты (для надежности можно использовать каплю цианокрилата на дно отверстия под магнит).
